...
const InvoicePage: FC<Props> = ({ data, pdfMode }) => {
  ...
  useEffect(() => {
    const saleTax = parseFloat(invoice.potlaVal)
    const Freight = parseFloat(invoice.freightVal)
    const Misc = parseFloat(invoice.miscVal)
    setSaleTax(saleTax)
    setFreight(Freight)
    setMisc(Misc)
  }, [subTotal,invoice.potlaVal,invoice.freightVal,invoice.miscVal])
      ...
      <Page className="invoice-wrapper" pdfMode={pdfMode}>
        ...
        <View className="flex" pdfMode={pdfMode}>
          ...
          <View className="w-50 mt-20" pdfMode={pdfMode}>
            ...
            <View className="w-50 p-5" pdfMode={pdfMode}>
                <Text pdfMode={pdfMode}>
                  {invoice.freightLabel}
                </Text>
              </View>
              <View className="w-50 p-5" pdfMode={pdfMode}>
                <EditableInput className="right bold dark"
                  value={invoice.freightVal}
                  onChange={(value) => handleChange('freightVal', value)}
                  pdfMode={pdfMode}
                />
              </View>
            </View>
            ...
            <View className="w-50 p-5" pdfMode={pdfMode}>
              ...
              <View className="w-50 p-5" pdfMode={pdfMode}>
                <EditableInput className="right bold dark"
                  value={invoice.miscVal}
                  onChange={(value) => handleChange('miscVal', value)}
                  pdfMode={pdfMode}
                />
              </View>
            </View>
